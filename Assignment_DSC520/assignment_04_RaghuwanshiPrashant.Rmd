...
##ANSWER if we compare the mean score of each section by using boxplots then will come to know that in regular section the mean score of students is more than the mean score of sport section
